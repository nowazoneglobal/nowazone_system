        ...
        <div className="max-w-md w-full text-center p-8 rounded-2xl bg-white dark:bg-[#0E1F33] border border-slate-200 dark:border-white/10 shadow-xl">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-lg border border-slate-200 dark:border-white/15 text-slate-700 dark:text-white/80 hover:bg-slate-50 dark:hover:bg-white/5 font-medium text-sm transition-colors"
            >
              Create Account
            </button>
          </div>
