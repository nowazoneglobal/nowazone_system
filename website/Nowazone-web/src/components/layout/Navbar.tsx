  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 px-4 sm:px-8 transition-all duration-300 ${
        scrolled
          ? 'py-2.5 bg-white/80 dark:bg-[#070E1A]/80 backdrop-blur-md border-b border-slate-200/80 dark:border-white/10 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_25px_-4px_rgba(0,0,0,0.4)]'
      ...
      <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-4 relative">
        ...
        >
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-[14px] font-semibold tracking-wide transition-all flex items-center gap-1.5 cursor-pointer select-none ${
              activeMenu === 'platforms'
                ...
                : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 dark:text-white/80 dark:hover:text-white dark:hover:bg-white/10'
            }`}
          >
            Platforms
            <ChevronDown
          ...
          <Link
            ...
            className="px-5 py-2 rounded-full text-[14px] font-semibold tracking-wide text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 dark:text-white/80 dark:hover:text-white dark:hover:bg-white/10 transition-colors"
          >
            FinOps
          </Link>
          ...
          {user ? (
            ...
            <button
              ...
              onMouseEnter={handleMouseLeave}
              className="px-5 py-2 rounded-full text-[14px] font-semibold tracking-wide text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 dark:text-white/80 dark:hover:text-white dark:hover:bg-white/10 transition-colors cursor-pointer"
            >
              Login
            </button>
          )}
                ...
                <div className="grid grid-cols-3 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Link
                      ...
                      className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/8 transition-all"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Link
                      to="/oracle-cloud-cost-optimization"
                      onClick={() => setActiveMenu(null)}
                      className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/8 transition-all"
                    >
                    ...
                    <Link
                      to="/alibaba-cloud-cost-optimization"
                      onClick={() => setActiveMenu(null)}
                      className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/8 transition-all"
                    >
                      <div className="w-9 h-9 rounded-xl bg-slate-100/90 dark:bg-white/5 border border-slate-200/90 dark:border-white/10 flex items-center justify-center p-1 flex-none group-hover:border-[#0F62FE]/50 group-hover:bg-[#0F62FE]/10 dark:group-hover:bg-[#0F62FE]/15 transition-all mt-0.5">
                    ...
                    <Link
                      to="/multi-cloud-cost-management"
                      onClick={() => setActiveMenu(null)}
                      className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/8 transition-all"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Link
                      to="/databricks-bigquery-cost-optimization"
                      onClick={() => setActiveMenu(null)}
                      className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/8 transition-all"
                    >
                      <div className="w-9 h-9 rounded-xl bg-slate-100/90 dark:bg-white/5 border border-slate-200/90 dark:border-white/10 flex items-center justify-center text-[#0F62FE] dark:text-[#60A5FA] flex-none group-hover:border-[#0F62FE]/50 group-hover:bg-[#0F62FE]/10 dark:group-hover:bg-[#0F62FE]/15 transition-all mt-0.5">
        ...
        <div className="hidden sm:flex items-center gap-2.5 flex-none">
          ...
          */}
          ...
          <button
            ...
            className="p-2 text-slate-600 dark:text-white/70 hover:text-slate-900 dark:hover:text-white border border-slate-300 dark:border-white/20 rounded bg-white/80 dark:bg-transparent hover:bg-slate-100 dark:hover:bg-white/10 transition-colors cursor-pointer shadow-sm dark:shadow-none"
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <button
            ...
            onClick={toggleTheme}
            aria-label="Toggle Theme"
            className="p-2 text-slate-700 dark:text-white/80 hover:text-slate-900 dark:hover:text-white border border-slate-300 dark:border-white/20 rounded bg-white/90 dark:bg-[#0E1F33] shadow-sm dark:shadow-none"
          >
            ...
            {user ? (
              <div className="py-2 border-t border-b border-slate-200 dark:border-white/10 space-y-1.5">
                ...
                <Link
                  to="/portal/submissions"
                  onClick={() => setMobileOpen(false)}
                  className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-slate-100 dark:hover:bg-white/5 text-sm text-slate-700 dark:text-white/80"
                >
                  <FileText size={15} />
                  <span>My Submissions</span>
                </Link>
