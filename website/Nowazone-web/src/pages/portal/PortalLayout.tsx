...
export const PortalLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070F1E] text-slate-900 dark:text-white flex flex-col md:flex-row transition-colors">
      ...
      <aside
        className={`fixed md:sticky top-0 h-screen w-64 lg:w-72 bg-white dark:bg-[#0E1F33] border-r border-slate-200 dark:border-white/10 flex flex-col justify-between z-40 transition-transform duration-300 md:translate-x-0 ${
            ...
            {navLinks.map(link => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center justify-between px-3.5 py-2.5 rounded-xl font-medium text-[13.5px] transition-all ${
                      isActive
