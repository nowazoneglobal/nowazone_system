        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 pb-12">
          ...
          <div className="lg:col-span-1.5 flex flex-col">
            ...
            <div className="flex items-center gap-4 flex-wrap mt-auto">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <div className="flex flex-col text-[12px] leading-none font-semibold text-slate-800 dark:text-white/80">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[13.5px] text-slate-600 dark:text-white/65">
              ...
              <li><Link to="/ai-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">AI FinOps (Tokenomics)</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[13.5px] text-slate-600 dark:text-white/65">
              ...
              <li><Link to="/ai-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">FinOps for AI</Link></li>
              <li><Link to="/databricks-bigquery-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">FinOps on Databricks</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[13.5px] text-slate-600 dark:text-white/65">
              <li><Link to="/azure-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">Microsoft Azure</Link></li>
              <li><Link to="/aws-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">AWS</Link></li>
              <li><Link to="/google-cloud-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">Google Cloud</Link></li>
              <li><Link to="/oracle-cloud-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">Oracle Cloud (OCI)</Link></li>
              <li><Link to="/alibaba-cloud-cost-optimization" className="hover:text-slate-900 dark:hover:text-white transition-colors">Alibaba Cloud</Link></li>
              <li><Link to="/multi-cloud-cost-management" className="hover:text-slate-900 dark:hover:text-white transition-colors">Multi-Cloud &amp; FOCUS</Link></li>
            </ul>
          </div>
