...
import { microsoftLicensingSchema } from '../../data/seoSchemas';
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        jsonLd={microsoftLicensingSchema}
      />
      ...
      <section className="bg-base-200/70 dark:bg-navy py-4 px-6 sm:px-10 text-base-content dark:text-white border-b border-base-300 dark:border-white/10 transition-colors">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-3 text-center text-sm">
          <span className="text-base-content/80 dark:text-white/80">Licensing is one input to your cloud bill, not the whole story.</span>
                  ...
                  {breakdownRows.map((row, idx) => {
                    ...
                    return (
                      <tr key={idx} className="hover:bg-base-200/50 dark:hover:bg-white/5">
                        ...
                        <td className="p-3 text-center text-base-content/80 dark:text-white/80">{row.basic}</td>
                        <td className="p-3 text-center text-base-content/80 dark:text-white/80">{row.standard}</td>
                        <td className="p-3 text-center text-base-content/80 dark:text-white/80">{row.premium}</td>
                        <td className="p-3 text-center text-base-content/80 dark:text-white/80">{row.e3}</td>
                        <td className="p-3 text-center text-base-content/80 dark:text-white/80 font-medium text-primary">{row.e5}</td>
                      </tr>
                    );
                  })}
                </tbody>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-base-100 dark:bg-navy rounded-2xl p-6 sm:p-8 text-base-content dark:text-white shadow-xl border border-base-300 dark:border-white/10">
            <div className="flex justify-between items-center mb-6">
              <span className="font-bold text-xs uppercase tracking-wider text-base-content/80 dark:text-white/80">License Waste Estimator</span>
