...
import { partnerProgramSchema } from '../data/seoSchemas';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-base-300 dark:border-white/10 bg-base-100 dark:bg-navy-light rounded-2xl p-8 relative shadow-sm">
              ...
              <div className="space-y-3 text-xs sm:text-sm text-base-content/80 dark:text-white/80 border-t border-base-200 dark:border-white/10 pt-5">
