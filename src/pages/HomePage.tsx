...
import { homeSchema } from '../data/seoSchemas';
                    ...
                    <div className="animate-fadeIn">
                      ...
                      <div className="bg-slate-50 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 rounded-xl p-3.5 mb-3 transition-colors">
                        ...
                        <div className="flex flex-col gap-2.5">
                          <div className="flex items-center gap-2.5 text-[12.5px] text-slate-800 dark:text-white/80">
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border border-base-300 dark:border-white/15 rounded-xl overflow-hidden shadow-sm dark:shadow-none">
            ...
            <div className="lg:col-span-7 bg-base-100 dark:bg-[#0E1F33] p-8 sm:p-10 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-base-300 dark:border-white/15">
              <p className="text-[17px] text-base-content/90 dark:text-white/85 leading-relaxed mb-8">
              ...
              <div>
                ...
                <div className="space-y-4 text-[14.5px]">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="block font-semibold text-base-content/90 dark:text-white/80">3–6 months hiring + ramp-up</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-red-500 dark:text-red-400 font-bold">✕</span>
                    <div>
                      <span className="block font-semibold text-base-content/90 dark:text-white/80">Salary + benefits + tools year-round</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-red-500 dark:text-red-400 font-bold">✕</span>
                    <div>
                      <span className="block font-semibold text-base-content/90 dark:text-white/80">One person, one cloud skillset</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-red-500 dark:text-red-400 font-bold">✕</span>
                    <div>
                      <span className="block font-semibold text-base-content/90 dark:text-white/80">You restart hiring if they leave</span>
            ...
            <div className="border-t border-base-300 dark:border-white/15 pt-5">
              ...
              <div className="flex flex-wrap gap-2">
                {['Landing Zone', 'Cost Estimate', 'Budgets & Alerts', 'Licensing', 'Azure', 'Google Cloud'].map((tag, idx) => (
                  <span
                    key={idx}
                    className="text-xs font-medium border border-base-300 dark:border-white/15 px-3 py-1.5 rounded-md bg-base-200/50 dark:bg-white/5 text-base-content/80 dark:text-white/80"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="border border-base-300 dark:border-white/15 rounded-xl p-8 bg-base-100 dark:bg-white/5 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <ul className="space-y-3 text-[13.5px] text-base-content/80 dark:text-white/80 mb-8">
            ...
            <div className="border-2 border-[#0F62FE] rounded-xl p-8 bg-blue-50/70 dark:bg-[#0F62FE]/15 flex flex-col justify-between relative shadow-xl">
              ...
              <div>
                ...
                <p className="text-[14px] text-base-content/80 dark:text-white/80 leading-relaxed mb-6">
